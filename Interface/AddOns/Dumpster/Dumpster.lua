...
function Dumpster:showPanel()
	...
	newbutt =  CreateFrame("Button","DumpsterNewButton",frame,"UIPanelButtonTemplate2")
        newbutt:SetText("New")
        newbutt:SetWidth(80)
	...
	delbutt =  CreateFrame("Button","DumpsterDelButton",frame,"UIPanelButtonTemplate2")
	...
	helpbutt =  CreateFrame("Button","DumpsterHelpButton",frame,"UIPanelButtonTemplate2")
