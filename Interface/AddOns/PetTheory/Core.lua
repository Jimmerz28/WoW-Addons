...
do
	...
	function private.PopulateSortedList()
		...
		for pet_index = 1, num_pets do
			...
			if not db.filters.zone_only or source_text:find(private.zone_name) or source_text:find(private.real_zone_name) or source_text:find(private.subzone_name) then
